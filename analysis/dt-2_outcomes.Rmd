...
# print all variables other than 'info'
print(vars %>% filter(Type != 'info') %>% filter(Type != 'comments') %>% pull('Variable'))
...
plotseries <- function(var){
    ...
    suppressMessages(ggsave(paste("output//dt-analysis//2-", gsub("[.]", "-", var), ".png", sep = "") 
          , plot))
