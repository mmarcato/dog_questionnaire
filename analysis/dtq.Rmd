...
h
suppressMessages(ggsave("analysis/dtq/duration-histogram.png",h))
```
...
write.csv(stats, "analysis/dtq/descriptive-statistics.csv") 
```
...
write.csv(lr_results, "analysis/dtq/univariate-logistic-regression.csv")
```
...
plot_items <- function(var){
    ...
    suppressMessages(ggsave(paste("analysis/dtq/", 
...
suppressMessages(ggsave("analysis/dtq/rfe-roc.png", plot))
plot
```
...
suppressMessages(ggsave(paste("analysis/dtq/logit-outcome.png"), plot))
...
suppressMessages(ggsave(paste("analysis/dtq/logit-status.png"), plot))
...
plot
suppressMessages(ggsave(paste("analysis/dtq/pc-explained-variance.png"), plot))
...
plot
suppressMessages(ggsave(paste("analysis/dtq/pc-cumulative-variance.png"), plot))
...
suppressMessages(ggsave(paste("analysis/dtq/pc-loadings.png"), plot))
plot
