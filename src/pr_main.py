...
def import_pr(base_dir):
    ...
    df = pd.read_csv(("%s\\PR-Questionnaire-Raw.csv" % base_dir), 
...
# save the dataframe
df.to_csv('%s\\2022-05-10-PR_C-BARQ.csv' % df_dir, index_label = 'Code')
print('New PR_C-BARQ Dataset available at: ', df_dir)
